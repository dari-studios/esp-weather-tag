...
void loop() {
   ...
   http.begin(wc, "https://api.openweathermap.org/data/2.5/onecall?lat=43.7001&lon=-79.4163&exclude=minutely,daily,alerts,current&appid=080eb4b45b6e311511e00f188c40ca03&units=metric&lang=en");  //Specify request destination
